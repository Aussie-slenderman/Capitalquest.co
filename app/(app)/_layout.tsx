  ...
  return (
    ...
    <Tabs
      ...
      screenOptions={{
        ...
        tabBarStyle: [styles.tabBar, { backgroundColor: appColorMode === 'light' ? '#FFFFFF' : '#000000', borderTopColor: appColorMode === 'light' ? '#E0E0E0' : '#1A1A1A', display: isSidebarOpen ? 'none' : 'flex' }],
